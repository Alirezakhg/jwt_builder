"""
Django settings for jwt_builder project.
...
SECRET_KEY = 'django-insecure-+i-x9gpai0#u4$hy=l61d+t+bl*y6xj)y-8uhh!1r(iyv%7yge'
...
WSGI_APPLICATION = 'jwt_builder.wsgi.application'
